...
def index():
    ...
    if request.method == 'POST':
        ...
        if action in ['generate', 'regenerate']:
            ...
            main_title, suggestions, description = generate_title(platform, topic, tone, seo=seo, include_emojis=include_emojis, title_char_limit=title_char_limit, title_word_limit=title_word_limit)
